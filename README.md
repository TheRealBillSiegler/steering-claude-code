...
Claims carry one of three provenance tiers — article digest, doc page, or dated live test. The skill's Source section links the official doc pages behind the mechanics; the dated article digest and everything else used to build and verify the skill live in this repo's [docs/research/](docs/research/), not in the installed payload.
